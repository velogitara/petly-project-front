...
import ClearInputSearchButton from 'components/ClearInputSearchButton/ClearInputSearchButton';
...
const InputSearch = ({ onSubmit, onClick, query }) => {
  return (
    <InputContainer id="searchForm">
      ...
      {query && <ClearInputSearchButton onClick={e => onClick(e)} query={query}></ClearInputSearchButton>}
